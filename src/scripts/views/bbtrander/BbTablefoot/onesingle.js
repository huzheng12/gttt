...
export default class Onesingle extends Component {
  ...
  render() {
    const {
      data,Cancel_order,type,ctypeis
    } = this.props

    return (
      <div className={ctypeis==='1'?"onesingle_warp":"onesingle_warp onesingle_warps"}>
        <div className="clo1 clo">
          {
            ctypeis==='1'?<div className="spl1">交易对</div>:<div className="spl2">
            {data.symbol}
          </div>
          }
        ...
        <div className="clo2 clo" style={{minWidth:'150px'}}>
        {
            ctypeis==='1'?<div className="spl1">委托时间</div>:<div className="spl2">
        ...
        {
            ctypeis==='1'?<div className="spl1">方向</div>:<div className="spl2">
        ...
        {
            ctypeis==='1'?<div className="spl1">成交比例</div>:<div className="spl2">
        ...
        {
            ctypeis==='1'?<div className="spl1">已成交量 | 委托总量</div>:<div className="spl2">
        ...
        {
            ctypeis==='1'?<div className="spl1">成交均价 | 委托价</div>: <div className="spl2">
        ...
        {
            ctypeis==='1'?<div className="spl1">状态</div>: <div className="spl2">
            {(() => {
              switch (data.status) {
        ...
        </div>
       {
         type==='1'? <div className="clo8 clo">
           {
            ctypeis==='1'?<div className="spl1">操作</div>:  <div className="spl2" onClick={() => Cancel_order(data)} style={{ color: "#2f6fed", cursor: 'pointer' }}>
            撤单
          </div>
          }
       ...
       {
            ctypeis==='1'?<div className="spl1">手续费</div>:   <div className="spl2">
            {data.fee}
          </div>
          }
        </div>
